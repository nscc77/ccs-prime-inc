module "dynamodb_table" {
  source        ="git::https://github.com/nscc77/final-project-serverless.git//terraform/dynamodb-module?ref=main"
...
module "lamda-module" {
  ...
  lambda_name        = "serverless24b-bravo-lambda"
...
module "ecr_repository" {
  source = "git::https://github.com/nscc77/final-project-serverless.git//terraform/ecr-module?ref=main"
...
module "static_website" {
  source = "git::https://github.com/nscc77/final-project-serverless.git//terraform/s3-module?ref=main"
